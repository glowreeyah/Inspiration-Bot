...
Telegram::Bot::Client.run(token) do |bot|
  bot.listen do |message_object|
    ...
    when %r{^/view}
      bot.api.send_message(chat_id: chat_id, text: "Here are your testimony entries: #{SaveMessage.new(message_object).messages}")
    ...
    when %r{^/delete}
      ...
      bot.api.send_message(chat_id: chat_id, text: "Reply with the testimony entry number to delete: #{SaveMessage.new(message_object).messages}")
